...
urlpatterns = [
    ...
    path("speech/star/voices/", views.QuickSpeechStarVoicesView.as_view(), name="quick_speech_star_voices"),
    path("speech/star/generate/", views.QuickSpeechStarGenerateView.as_view(), name="quick_speech_star_generate"),
